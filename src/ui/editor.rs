...
use eframe::{
    egui::{self, CollapsingHeader, Frame, Key, Margin, Sense, SidePanel, TextEdit, TextStyle, Ui, PointerButton},
...
use super::{
    designer::Designer, drawing, selection::SelectionInventoryItem, CollapsibleSidePanel,
